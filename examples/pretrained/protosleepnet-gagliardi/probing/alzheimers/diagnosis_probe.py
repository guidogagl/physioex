"""Alzheimer diagnosis (HC vs AD) with LOSO cross-validation.

Classifies HC (healthy controls) vs AD (Alzheimer's disease)
...
Usage:
    python diagnosis_probe.py \
        ...
        --source_name alzheimers --output_dir /out
"""
import argparse
import glob
import json
...
def main():
    parser = argparse.ArgumentParser(
        description="Alzheimer diagnosis HC vs AD (LOSO)"
    )
