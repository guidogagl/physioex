"""Disease diagnosis (HOA vs PD) with LOSO cross-validation.

Classifies HOA (healthy older adults) vs PD (Parkinson's disease)
using codebook prototype permanence features.
Uses class_weight="balanced" for robustness.

Usage:
    python diagnosis_probe.py \
...
def main():
    parser = argparse.ArgumentParser(
        description="Disease diagnosis HOA vs PD (LOSO)"
    )
