"""Evaluate chambon2018 on all supported datasets.

Downloads the pretrained model via ``load_from_pretrained("chambon2018")``,
...
Note: Chambon2018Net takes (B, L, C, T) and outputs (B, 1, 5) — it predicts
...
Usage:
    python examples/pretrained/chambon2018/test_pretrained.py --gpu_id 0
    python examples/pretrained/chambon2018/test_pretrained.py --gpu_id 0 --datasets sleepedf hmc
    python examples/pretrained/chambon2018/test_pretrained.py --gpu_id 0 --upload
"""
import argparse
import json
import os
...
def print_summary_table(all_results):
    ...
    print("\n" + "=" * 60)
    print("Chambon2018 — Per-Dataset Evaluation Summary")
    print("=" * 60)
    print(header)
    print("-" * 60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate chambon2018 on all supported datasets"
    )
    parser.add_argument(
    ...
    # ── Load model ───────────────────────────────────────────────────
    print("Loading pretrained Chambon2018Net from HuggingFace...")
