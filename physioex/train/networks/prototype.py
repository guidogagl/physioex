...
class NN(nn.Module):
    def __init__(self, module_config = module_config):
        ...
        t_layer = nn.TransformerEncoderLayer(
            d_model=128, # input is reshaped so that each channel is processed as an independent sample, otherwise it would be 128 * in_channels
            nhead=8,
        ...
        # need to change n_channels to 1 because each channel is processed independently
