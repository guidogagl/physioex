...
class Mass(PhysioExDataset):
    def __init__(
        ...
        self.split_path = str(Path.home()) + f"/mass/data_split_eval.mat"

        self.data_path = str(Path.home()) + f"/mass/{preprocessing}/"
        ...
        scaling_file = np.load(str(Path.home()) + f"/mass/{preprocessing}/scaling.npz")
